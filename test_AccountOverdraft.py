...
class TestAccountOverdraft(TestCase):
    ...
    def test_withdraw_with_overdraft(self):
        self.a.execute_transaction(AccountTransaction(-300, ''))
    ...
    def test_withdrawal_while_overdrawn(self):
        ...
        self.a.execute_transaction(AccountTransaction(-100, ''))
        ...
        self.a.execute_transaction(AccountTransaction(-200, ''))
        self.assertEqual(-300, self.a.balance)
        self.assertEqual(200, self.a.get_overdraft_amount_available())

    def test_deposit_not_in_overdraft(self):
        self.b.execute_transaction(AccountTransaction(550, ''))
        self.assertEqual(550, self.b.balance)
        self.b.execute_transaction(AccountTransaction(450, ''))
    ...
    def test_deposit_in_overdraft_to_positive_balance(self):
        ...
        self.a.execute_transaction(AccountTransaction(-450, ''))
        ...
        self.a.execute_transaction(AccountTransaction(1000, ''))
