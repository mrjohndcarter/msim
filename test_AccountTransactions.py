...
class TestAccountTransactions(TestCase):
    ...
    def test_insufficient_funds(self):
        ...
        self.assertEqual(3, len(self.a.transaction_history))
    ...
    def test_overdraft_transactions(self):
        ...
        self.assertEqual(3, len(b.transaction_history))
    ...
    def test_transactions_and_balance_consistency(self):
        ...
        self.assertEqual(11, len(c.transaction_history))

        for _ in repeat(None, 10):
            c.execute_transaction(AccountTransaction(25, 'No description'))
        self.assertEqual(250, c.balance)
        self.assertEqual(21, len(c.transaction_history))

        sum = 0  # (opening balance is first transaction)
    ...
    def test_transaction_rollback(self):
        ...
        self.assertEqual(3, len(e.transaction_history))
